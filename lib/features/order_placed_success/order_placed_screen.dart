              ...
              child: padded(
                Column(
                  ...
                  children: [
                    ...
                    Text("Order Placed \nSuccessfully", style: AppTextStyles.heading,), 
                    const SizedBox(height: 25,), 
                    Text("You will recieve an email confirmation", style: TextStyle(fontSize: 16, fontWeight: .w500, color: Color(0xff27272780)),), 
                    const SizedBox(height: 78,), 
                    MainButton(text: "See Order details", height: 52, width: .infinity, page: HomePage())
